	...
	<div class="control_bar">
		...
		<div class="control_container">
			<div class="control_buttons_container">
				...
				<div class="button" id="forward_10">
					<svg viewBox="0 0 24 24">
				...
				<div class="button" id="volume">
					...
					<div class="popup" id="volume_slider">
						<div class="bar">
							<div class="progress"></div>
							<div class="cursor"></div>
						</div>
			...
			<div class="config_buttons_container">
				<div class="button" id="audio_subtitle_button">
					...
					<div class="popup" id="audio_subtitle_popup">
						<div class="category" id="audio">
							...
							<div class="values">
								<p :class="{selected: index == 0}" v-for="(audio, index) in audios" :key="index">
									<span>
										<svg viewBox="0 0 24 24">
				...
				<div class="button" id="speed_button">
					...
					<div class="popup" id="speed_popup">
						...
						<div class="slider_container">
							<div class="line"></div>
							<div class="speed_item" data-value="0.5">
								<svg viewBox="0 0 8 8">
									<circle cx="4" cy="4" r="4" fill="currentColor"></circle>
								</svg>
								<p>0.5x</p>
							</div>
							<div class="speed_item" data-value="0.75">
								<svg viewBox="0 0 8 8">
									<circle cx="4" cy="4" r="4" fill="currentColor"></circle>
								</svg>
								<p>0.75x</p>
							</div>
							<div class="speed_item" data-value="1">
								<svg viewBox="0 0 8 8">
									<circle cx="4" cy="4" r="4" fill="currentColor"></circle>
								</svg>
								<p>1.0x</p>
							</div>
							<div class="speed_item" data-value="1.25">
								<svg viewBox="0 0 8 8">
									<circle cx="4" cy="4" r="4" fill="currentColor"></circle>
								</svg>
								<p>1.25x</p>
							</div>
							<div class="speed_item" data-value="1.5">
								<svg viewBox="0 0 8 8">
									<circle cx="4" cy="4" r="4" fill="currentColor"></circle>
								</svg>
								<p>1.5x</p>
				...
				<div class="button" id="fullscreen_button">
					<svg viewBox="0 0 24 24">
